...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = '㑒 Ari Offc ϟ〽️' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = '[⫹⫺ - 㑒 MrX-SkY ϟ〽️]' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'Ari Offc ϟ' //ubah jadi nama mu, note tanda ' gausah di hapus!
...
global.packname = 'Ari Offc ϟ'
global.ownerr = ['㑒 Ari Offc ϟ〽️']
global.author = '[⫹⫺ - 㑒 Ari Offc ϟ〽️]'
global.prefa = ['','!','.',',','🐤','🗿']
global.sp = '⭔'
global.mess = {
